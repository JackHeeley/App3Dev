...
#pragma warning(disable: 26447)
   static std::shared_ptr<logger_interface> getInstance(logger_type loggerType=logger_type::null_logger, std::string filePath="", LogFilter logFilter = LogFilter::None)
   {
...
private:
   ...
   static std::shared_ptr<logger_interface> createLogger(logger_type loggerType, std::string filePath, LogFilter logFilter)
   {
      switch (loggerType)
      {
